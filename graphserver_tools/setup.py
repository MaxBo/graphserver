...
setup(  name='graphserver_tools',
        ...
        packages=['graphserver_tools', 'graphserver_tools.utils', 'graphserver_tools.ext',
         'graphserver_tools.ext.dino', 'graphserver_tools.ext.dino.models',
         'graphserver_tools.ext.ivu', 'graphserver_tools.ext.ivu.models' ],
        ...
        entry_points={
            'console_scripts': [
                ...
                'gst_dinoToVisum = graphserver_tools.ext.dinoToVisum:main',
            ],
        }
     )
