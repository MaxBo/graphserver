...
class GoogleReader:
    ...
    def ProcessCalendar(self, calendarfile, datesfile, useDate, filterDate):
        ...
        no = 2 # start with 2 to avoid conflict with default "daily"
    ...
    def ProcessStops(self, stopfile):
        keepGoing = self.progdlg.Update(0, _("Processing stops"))
    ...
    def Main(self, path, useDate, filterDate):
        ...
        global Visum
        Visum = com.Dispatch("Visum.Visum.115") #debug
        self.SetProjection()
        self.CreateTSys()
...
local1 ="C:\\Program Files\\PTV_Vision\\VISUM115\\Exe\\AddIns\\GoogleTransit\\locale\\"
translation = gettext.translation("GoogleTransit", local1, languages=[code])
translation.install()

if Parameter.OK:
    app = wx.PySimpleApp(0)# If True Traceback window in VISUM appears
